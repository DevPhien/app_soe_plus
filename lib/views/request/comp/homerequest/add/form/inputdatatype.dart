...
import 'package:soe/views/request/comp/homerequest/add/form/numerictextformatter.dart';
        ...
        inputDataType = Obx(
          () => ListTile(
            ...
            leading: Checkbox(
                ...
                value:
                    controller.model["checkbox${input["FormD_ID"]}"] ?? false,
                onChanged: (val) {
      ...
      case "radio":
        inputDataType = Obx(
          () => RadioListTile<String>(
            selected: controller.model["radio"] == input["FormD_ID"],
            value: input["FormD_ID"],
            groupValue: controller.model["radio"] ?? "",
            title: Text(
              "${input["TenTruong"]}",
              style: Golbal.styleinput,
            ),
