...
import 'package:soe/views/request/comp/homerequest/countrequest.dart';
import 'package:soe/views/request/comp/homerequest/itemrequest.dart';
import 'package:soe/views/request/controller/requestcontroller.dart';

class HomeRequest extends StatelessWidget {
  final RequestController controller = Get.put(RequestController());
  HomeRequest({Key? key}) : super(key: key);

  Widget itemBuilder(ct, i) =>
      ItemRequest(request: controller.datas[i], onClick: controller.goRequest);
          ...
          () => AnimatedSlide(
              ...
              child: AnimatedOpacity(
                ...
                child: FloatingActionButton(
                  ...
                  tooltip: 'Thêm mới đề xuất',
                  onPressed: controller.openAddRequest,
                ),
              )),
        ),
