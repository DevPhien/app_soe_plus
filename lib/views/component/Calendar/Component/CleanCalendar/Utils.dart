...
class Utils {
  static final DateFormat _monthFormat =  new DateFormat("MMMM yyyy","vi");
  static final DateFormat _dayFormat = new DateFormat("dd","vi");
  static final DateFormat _firstDayFormat = new DateFormat("dd MMM","vi");
  static final DateFormat _fullDayFormat = new DateFormat("EEE dd MMM, yyyy","vi");
  static final DateFormat _apiDayFormat = new DateFormat("dd-MM-yyyy","vi");
