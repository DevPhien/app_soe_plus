...
class ChitietThongbaoController extends GetxController {
  ...
  initUsers() async {
    ...
    try {
      var body = {
        "Thongbao_ID": thongbao["Thongbao_ID"],
      };
      Dio dio = Dio();
          ...
          children: [
            ...
            Expanded(
                child: Obx(() => ListView.separated(
                    ...
                    itemBuilder: (ct, i) => ItemUserThongBao(user: users[i]))))
          ],
        ),
      ),
    );
  ...
  initData() async {
    ...
    try {
      ...
      var response = await dio
          .post("${Golbal.congty!.api}/api/Notify/Get_NotifyByID", data: body);
      var data = response.data;
      isLoadding.value = false;
      if (data != null) {
        var tbs = List.castFrom(json.decode(data["data"]));
