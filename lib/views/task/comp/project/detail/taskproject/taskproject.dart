...
import 'package:soe/views/task/comp/project/detail/taskproject/taskprojectcotroller.dart';

class TaskProject extends StatelessWidget {
  final TaskProjectController controller = Get.put(TaskProjectController());
  TaskProject({Key? key}) : super(key: key);
