...
import 'filtertaskcontroller.dart';

class FilterTask extends StatelessWidget {
  final FilterTaskController controller = Get.put(FilterTaskController());
  FilterTask({
    Key? key,
  }) : super(key: key);
  ...
  Widget fileVB(IconData icon, String title, RxList<dynamic> datas, String id,
    ...
    return Column(
      ...
      children: [
        ListTile(
          onTap: () {
            showModalFilterTask(title, datas, id, name, key, isOne);
          },
          leading: Icon(icon),
          title:
