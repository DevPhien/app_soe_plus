...
import '../../component/use/itemgroupchon.dart';
...
class ListGroup extends StatelessWidget {
  ...
  Widget widgetListGroup() {
    return ListView.separated(
      itemCount: controller.groups.length,
      itemBuilder: (ct, i) => ItemGroupVanbanChon(
          donvi: controller.groups[i],
          one: false,
          onClick: controller.onChangeGroup),
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Container(
              ...
              child: Center(
                child: TextField(
                  onSubmitted: controller.searchGroup,
          ...
          body: Obx(() =>
              controller.groups.isEmpty || controller.isloadding.value
