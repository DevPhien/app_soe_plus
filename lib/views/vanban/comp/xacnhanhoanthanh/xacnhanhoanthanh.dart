...
import 'xacnhanhoanthanhcontroller.dart';

class XacnhanHoanthanhVanBan extends StatelessWidget {
  final XacnhanHoanthanhVanbanController controller =
      Get.put(XacnhanHoanthanhVanbanController());
  XacnhanHoanthanhVanBan({
    Key? key,
  }) : super(key: key);
        ...
        child: DefaultTabController(
            ...
            child: KeyboardDismisser(
              ...
              appBar: AppBar(
                ...
                title: Text("Xác nhận hoàn thành công việc",
                    style: TextStyle(
