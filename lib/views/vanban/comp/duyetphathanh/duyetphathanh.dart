...
import 'duyetphathanhcontroller.dart';

class DuyetPhathanhVanBan extends StatelessWidget {
  final DuyetPhathanhVanbanController controller =
      Get.put(DuyetPhathanhVanbanController());
    ...
    return Obx(() => Wrap(children: [
          if (controller.vanbandinhkemkys.isNotEmpty)
            Padding(
                padding: const EdgeInsets.symmetric(vertical: 10),
                child: Text(
                  "Chèn chữ ký cho File đính kèm khác:",
                  style: titleFile,
                )),
          if (controller.vanbandinhkemkys.isNotEmpty)
            Wrap(
  ...
  Widget formWidget() {
    ...
    return Form(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Ký điện tử (Sim CA)", style: Golbal.stylelabel),
                Obx(() => Switch(
                      value: controller.model["Kysim"] ?? true,
                      onChanged: (value) {
                        controller.model["Kysim"] = value;
                      },
                    )),
              ],
            )),
        ...
        Obx(() => controller.model["Kysim"] == true
            ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                breakRow,
                Text("Lý do", style: Golbal.stylelabel),
                breakRow,
                TextFormField(
                  minLines: 5,
                  maxLines: 10,
                  ...
                  style: Golbal.styleinput,
                  onChanged: (String txt) => controller.model["lydo"] = txt,
                ),
                breakRow,
                Text("Điạ điểm", style: Golbal.stylelabel),
                breakRow,
                TextFormField(
                  minLines: 5,
                  maxLines: 10,
                  decoration: Golbal.decoration,
                  style: Golbal.styleinput,
                  onChanged: (String txt) => controller.model["diadiem"] = txt,
                ),
                breakRow,
                Row(
                  children: [
                    Text('Hiển thị "Ký bởi"', style: Golbal.stylelabel),
                    Switch(
                      value: controller.model["Kyboi"] ?? true,
                      onChanged: (value) {
                        controller.model["Kyboi"] = value;
                      },
                    )
                  ],
                )
